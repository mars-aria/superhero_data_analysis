...
df.to_csv('superhero_data_analysis.csv', index=False)


# In[22]:


df_saved_file = pd.read_csv('superhero_data_analysis.csv')
df_saved_file
...
df.to_csv('/Users/RAI/superhero_data_analysis.csv', index=False)
